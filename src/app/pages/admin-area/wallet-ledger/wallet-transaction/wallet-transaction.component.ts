...
import { WalletTransactionService } from '../../../../shared/component-services/admin-area.services.ts/wallet-transaction';
@Component({
  selector: 'ngx-wallet-transaction',
...
export class WalletTransactionComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public wallateService: WalletTransactionService,
  ...
  public findCustomerTransaction() {
    ...
    let payloadObj: any = {};
    payloadObj.user_id = this.customerForm.get('user_id').value
